...
v_result = dbutils.notebook.run("2.ingest_races_files", 0, {"p_data_source": "Ergast API", "p_file_date": "2021-04-18"})

# COMMAND ----------

v_result = dbutils.notebook.run("3.Ingest_Contructor_file", 0, {"p_data_source": "Ergast API", "p_file_date": "2021-04-18"})
